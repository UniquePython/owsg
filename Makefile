...
THIRDPARTY_INCLUDES := -isystem $(INC_DIR)/thirdparty/glad -isystem $(INC_DIR)/thirdparty/cglm -isystem $(INC_DIR)/thirdparty/stb -isystem $(INC_DIR)/thirdparty/open-simplex-noise
